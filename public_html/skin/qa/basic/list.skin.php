...
<h1 style="text-align:center">1:1문의</h1>
    ...
    <div id="bo_btn_top">
        ...
        <ul class="btn_bo_user">
            ...
            <?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn_b01 btn" title="문의등록"><i class="fa fa-pencil" aria-hidden="true"></i><span class="sound_only bg_yellow">문의등록</span></a></li><?php } ?>
        </ul>
        <?php } ?>
    </div>
    <!-- } 게시판 페이지 정보 및 버튼 끝 -->
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr>
            ...
            <th scope="col" class="all_chk chk_box">
            	...
            	<label for="chkall">
                	<span></span>
                	<b class="sound_only1">현재 페이지 게시물  전체선택</b>
                </label>
            </th>
            <?php } ?>
            <!-- <th scope="col">번호</th> -->
        ...
        <tr class="<?php echo $lt_class ?>">
            ...
            <td class="td_chk chk_box">
                ...
                <label for="chk_qa_id_<?php echo $i ?>">
            		<span></span>
            		<b class="sound_only1"><?php echo $list[$i]['subject'] ?></b>
            	</label>
            </td>
            <?php } ?>
