...
function checkSubmit(){
	...
	//테스트 URL 
	HForm.action = "http://tpay.billgate.net/credit/abroad/certify.jsp";
	//상용 URL 
	//HForm.action = "https://pay.billgate.net/credit/abroad/certify.jsp";
...
<table width="500" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<table width="450" border="0" cellpadding="5" cellspacing="1" bgcolor="#B0B0B0">
			...
			<tr>
				<td width="100" align="center" bgcolor="#F6F6F6">카드구분</td>
				<td bgcolor="#FFFFFF">&nbsp;
					<select name="USING_TYPE">
						<option value="0000">국내카드</option>
						<option value="0001" selected>해외카드</option>
					</select>&nbsp;국내카드:0000  해외카드:0001
				</td>
			</tr>
			<tr>
				<td width="100" align="center" bgcolor="#F6F6F6">승인 통화 구분</td>
				<td bgcolor="#FFFFFF">&nbsp;
					<select name="CURRENCY">
						<option value="0000">원화승인</option>
						<option value="0001" selected>달러승인</option>
					</select>&nbsp;원화승인:0000  달러승인:0001
				</td>
			</tr>
			<tr>
